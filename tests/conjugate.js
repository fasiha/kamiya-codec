...
test("Tagaru", (t) => {
  ...
  t.ok(
    has(conjugateAuxiliaries("遊ぶ", ["Tagaru"], "Conjunctive"), "遊びたがり"),
  );
  t.ok(
    has(conjugateAuxiliaries("遊ぶ", ["Tagaru"], "Dictionary"), "遊びたがる"),
  );
...
test("Hoshii", (t) => {
  t.ok(
    has(
      conjugateAuxiliaries("見る", ["Hoshii"], "Negative", true),
      "見てほしくない",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("見る", ["Hoshii"], "Conjunctive", true),
      "見てほしく",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("見る", ["Hoshii"], "Dictionary", true),
      "見てほしい",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("見る", ["Hoshii"], "Conditional", true),
      "見てほしければ",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("見る", ["Hoshii"], "Tara", true),
      "見てほしかったら",
    ),
  );
  t.end();
...
test("Rashii", (t) => {
  t.ok(
    has(conjugateAuxiliaries("帰る", ["Rashii"], "Conjunctive"), "帰るらしく"),
  );
  t.ok(
    has(conjugateAuxiliaries("帰る", ["Rashii"], "Dictionary"), "帰るらしい"),
  );
  t.ok(has(conjugateAuxiliaries("帰る", ["Rashii"], "Te"), "帰るらしくて"));
  t.ok(
    has(conjugateAuxiliaries("帰る", ["Rashii"], "Negative"), "帰らないらしい"),
  );
  t.end();
});
...
test("Souda, both Hearsay and Conjecture", (t) => {
  ...
  t.ok(
    has(
      conjugateAuxiliaries("倒れる", ["SoudaConjecture"], "Dictionary", true),
      "倒れそうだ",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("倒れる", ["SoudaConjecture"], "Conditional", true),
      "倒れそうなら",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("倒れる", ["SoudaConjecture"], "Ta", true),
      "倒れそうだった",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("読む", ["Potential", "SoudaConjecture"], "Ta"),
      "読めそうでした",
    ),
  );
  t.end();
...
test("Saseru/seru", (t) => {
  t.ok(
    has(conjugateAuxiliaries("歩く", ["SeruSaseru"], "Dictionary"), "歩かせる"),
  );
  t.ok(has(conjugateAuxiliaries("歩く", ["SeruSaseru"], "Negative"), "歩かせ"));
  t.ok(
    has(
      conjugateAuxiliaries("食べる", ["SeruSaseru"], "Dictionary", true),
      "食べさせる",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("食べる", ["SeruSaseru"], "Imperative", true),
      "食べさせろ",
    ),
  );
  t.ok(
  ...
  t.ok(
    has(conjugateAuxiliaries("来る", ["SeruSaseru"], "Dictionary"), "来させる"),
  );
  t.ok(
    has(
      conjugateAuxiliaries("来る", ["SeruSaseru"], "Conditional"),
      "来させれ",
    ),
  );
  t.ok(
    has(conjugateAuxiliaries("する", ["SeruSaseru"], "Dictionary"), "させる"),
  );
  t.ok(
    has(conjugateAuxiliaries("する", ["SeruSaseru"], "Volitional"), "させよう"),
  );
  t.end();
});
...
test("Shortened causative seru", (t) => {
  t.ok(
    has(
      conjugateAuxiliaries("歩く", ["ShortenedCausative"], "Dictionary"),
      "歩かす",
    ),
  );
  t.ok(
  ...
  t.ok(
    has(
      conjugateAuxiliaries("来る", ["ShortenedCausative"], "Dictionary"),
      "来さす",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("する", ["ShortenedCausative"], "Dictionary"),
      "さす",
    ),
  );
  t.end();
...
test("Rareru/reru", (t) => {
  t.ok(
    has(conjugateAuxiliaries("読む", ["ReruRareru"], "Dictionary"), "読まれる"),
  );
  t.ok(
    has(
      conjugateAuxiliaries("ほめる", ["ReruRareru"], "Dictionary", true),
      "ほめられる",
    ),
  );
  t.ok(
    has(conjugateAuxiliaries("来る", ["ReruRareru"], "Dictionary"), "来られる"),
  );
  t.ok(
    has(conjugateAuxiliaries("する", ["ReruRareru"], "Dictionary"), "される"),
  );
  t.end();
});
...
test("Causative-passive", (t) => {
  t.ok(
    has(
      conjugateAuxiliaries("書く", ["CausativePassive"], "Negative"),
      "書かせられ",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("書く", ["CausativePassive"], "Conjunctive"),
      "書かせられ",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("書く", ["CausativePassive"], "Dictionary"),
      "書かせられる",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("書く", ["CausativePassive"], "Te"),
      "書かせられて",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("書く", ["CausativePassive"], "Ta"),
      "書かせられた",
    ),
  );
  t.end();
...
test("Causative-passive", (t) => {
  t.ok(
    has(
      conjugateAuxiliaries("歩く", ["ShortenedCausativePassive"], "Negative"),
      "歩かされ",
    ),
  );
  t.ok(
  ...
  t.ok(
    has(
      conjugateAuxiliaries("歩く", ["ShortenedCausativePassive"], "Dictionary"),
      "歩かされる",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("歩く", ["ShortenedCausativePassive"], "Te"),
      "歩かされて",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("歩く", ["ShortenedCausativePassive"], "Ta"),
      "歩かされた",
    ),
  );
  t.end();
...
test("Potential", (t) => {
  t.ok(
    has(conjugateAuxiliaries("書く", ["Potential"], "Dictionary"), "書ける"),
  );
  t.ok(
    has(conjugateAuxiliaries("読む", ["Potential"], "Dictionary"), "読める"),
  );
  ...
  t.ok(
    has(conjugateAuxiliaries("離す", ["Potential"], "Negative"), "離せない"),
  );
  t.end();
});
...
test("Check that nai/masu/etc. multiple choice endings are there", (t) => {
  ...
  t.ok(
    has(
      conjugateAuxiliaries("あるく", ["SeruSaseru"], "Conjunctive"),
      "あるかせます",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("あるく", ["SeruSaseru"], "Conditional"),
      "あるかせれば",
    ),
  );
  ...
  t.ok(
    has(
      conjugateAuxiliaries("食べる", ["SeruSaseru"], "Negative", true),
      "食べさせない",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("食べる", ["SeruSaseru"], "Conjunctive", true),
      "食べさせます",
    ),
  );
  t.ok(
    has(
      conjugateAuxiliaries("食べる", ["SeruSaseru"], "Conditional", true),
      "食べさせれば",
    ),
  );
  ...
  t.ok(
    has(
      conjugateAuxiliaries("する", ["SeruSaseru"], "Conditional"),
      "させれば",
    ),
  );
  ...
  t.ok(
    has(conjugateAuxiliaries("いく", ["Masu"], "Negative"), "いきませんでした"),
  );
